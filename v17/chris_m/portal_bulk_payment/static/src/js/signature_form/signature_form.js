...
class SignatureFormVk extends Component {
    static template = "portal_bulk_payment.SignatureForm"
    ...
    async onClickSubmit() {
        ...
        const data = await this.rpc(this.props.callUrl, { order_ids,name, signature });
...
registry.category("public_components").add("portal_bulk_payment.SignatureForm", SignatureFormVk);
